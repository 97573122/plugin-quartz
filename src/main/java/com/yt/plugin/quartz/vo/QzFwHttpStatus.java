 ...
 * @author Brian Clozel
 * @since 3.0
 * @see QzFwHttpStatus.Series
 * @see <a href="http://www.iana.org/assignments/http-status-codes">HTTP Status Code Registry</a>
 * @see <a href="http://en.wikipedia.org/wiki/List_of_HTTP_status_codes">List of HTTP status codes - Wikipedia</a>
 */
public enum QzFwHttpStatus {
	 ...
	 * @deprecated in favor of {@link #FOUND} which will be returned from {@code QzFwHttpStatus.valueOf(302)}
	 */
	@Deprecated
	 ...
	 * @deprecated in favor of {@link #PAYLOAD_TOO_LARGE} which will be returned from {@code QzFwHttpStatus.valueOf(413)}
	 */
	@Deprecated
	 ...
	 * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code QzFwHttpStatus.valueOf(414)}
	 */
	@Deprecated
	...
	/**
	 * {@code 555 Background tips} 后台返回的提示信息使用此状态码.
	 */
	FW_BACKGROUND_TIP(550, "Background tips"),
	/**
	 * {@code 551  Password timeout} 登录时密码过期使用此状态码
	 */
	FW_USER_PASSWORD_TIMEOUT(551, "Password timeout"),
	/**
	 * {@code 552  Default password} 登录时还是初始化密码使用此状态码
	 */
	FW_USER_DEFAULT_PASSWORD(552, "Default password");
    ...
    QzFwHttpStatus(int value, String reasonPhrase) {
		this.value = value;
	 ...
	 * {@link com.yt.plugin.quartz.vo.QzFwHttpStatus.Series#INFORMATIONAL}.
	...
	/**
	 * Whether this status code is in the HTTP series
	 * {@link com.yt.plugin.quartz.vo.QzFwHttpStatus.Series#SUCCESSFUL}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * Whether this status code is in the HTTP series
	 * {@link com.yt.plugin.quartz.vo.QzFwHttpStatus.Series#REDIRECTION}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * Whether this status code is in the HTTP series
	 * {@link com.yt.plugin.quartz.vo.QzFwHttpStatus.Series#CLIENT_ERROR}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * Whether this status code is in the HTTP series
	 * {@link com.yt.plugin.quartz.vo.QzFwHttpStatus.Series#SERVER_ERROR}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	 ...
	 */
	public static QzFwHttpStatus valueOf(int statusCode) {
		for (QzFwHttpStatus status : values()) {
	 ...
	 * <p>Retrievable via {@link QzFwHttpStatus#series()}.
	 */
	public enum Series {
		...
		public static Series valueOf(QzFwHttpStatus status) {
